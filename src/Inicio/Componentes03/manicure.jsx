    ...
    return (
        <section className="text-light container py-5 manicure">
            ...
            <div className="row itens-manicure">
                <div className="item-manicure" data-aos="fade-up">
                    <img src="../../../img/icon-mao.png" alt="Ícone de mão para serviço de manicure" />
                    <h4>Manicure</h4>
                ...
                <div className="item-manicure" data-aos="fade-up">
                    <img src="../../../img/icon-pe.png" alt="Ícone de pé para serviço de pedicure" />
                    <h4>Pedicure</h4>
                ...
                <div className="item-manicure" data-aos="fade-up">
                    <img src="../../../img/icon-alongamento.png" alt="Ícone de unha para serviço de alongamento" />
